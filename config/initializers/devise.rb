...
Devise.setup do |config|
  ...
  # config.secret_key = '10c1d48e414fc3dbeec65cc93ee836db457b844dbd
  # 6218c795daefd2ce9015d2cf1aa2a76a625dbd74702495a79027b4c55335480
  # 1af35b0a1b79efa3eccda0a'
  ...
  config.mailer_sender = 'kellywdev@gmail.com'
  ...
  # However, it is STRONGLY RECOMMENDED to not use a value less
  # than 10 in other environments. Note that, for bcrypt (the default
  # algorithm), the cost increases exponentially with the number
  # of stretches (e.g. a value of 20 is already
  # extremely slow: approx. 60 seconds for 1 calculation).
  config.stretches = Rails.env.test? ? 1 : 11

  # Set up a pepper to generate the hashed password.
  # config.pepper = '627d46a5e9632277bf1f38ec3c405f07a764f63e
  # 7dca43f5141ad4e736329b87c49640d7abc0ac3df0df799a40a03650a
  # f79fd2696481e14956dc61550af8d44'
