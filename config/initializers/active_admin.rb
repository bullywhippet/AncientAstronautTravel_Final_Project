ActiveAdmin.setup do |config|
  ...
  #
  config.site_title = 'Ancient Astronaut Tours'
  ...
  #
  # Create another checkbox is disabled by default. You can
  # customize it for individual
  ...
  #
  # To change the default utility navigation to show a link to
  # your website & a logout btn
  #
  #   config.namespace :admin do |admin|
